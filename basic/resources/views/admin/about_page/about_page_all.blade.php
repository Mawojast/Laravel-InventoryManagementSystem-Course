    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea require="" class="form-control" rows="5" name="short_description">{{ $aboutpage->short_description }}</textarea>
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea id="elm1" name="long_description" class="form-control">
