        ...
        <div class="card-body">
            ...
            <div class="col-md-1">
                <div class="md-3">
                    ...
                    <input class="form-control example-date-input" name="invoice_no" type="text"  id="invoice_no" readonly style="background-color: #ddd" value="{{$invoice_no}}">
                </div>
            </div>
            ...
            <div class="col-md-1">
                <div class="md-3">
                    <label for="example-text-input" class="form-label">Stock(PicKg)</label>
